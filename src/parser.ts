...
import type { HttpStep, CliStep, SqlStep, Step, Test, ParseResult } from './types.js';

export type { SpecConfig } from './types.js';
export type { HttpStep, CliStep, SqlStep, Step, Test, ParseResult } from './types.js';
